...
class NumericStringParser(object):
    ...
    def __init__(self):
        ...
        self.opn = { "+" : operator.add,
                ...
                "/" : operator.truediv,
                "^" : operator.pow }
        self.fn  = { "sin" : math.sin, "cos" : math.cos, "tan" : math.tan, "abs" : abs, "trunc" : lambda a: int(a), "round" : round, "sgn" : lambda a: abs(a)>epsilon and cmp(a,0) or 0}
    ...
    def execute(self, *args):
        if "--help" in args:
            ...
            try:
                ...
                self.shell.stdout.write(str(self.parser.eval(expression)))
            except:
